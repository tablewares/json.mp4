...
import { getBundleOutDir } from "./bundleOutDir.js";
...
async function main() {
  ...
  // removing the old ones. Pin it to one stable, repo-local dir so exactly
  // one bundle dir ever exists and is reused across all renders.
  const bundleOutDir = getBundleOutDir(path.join(__dirname, "../../.."));
