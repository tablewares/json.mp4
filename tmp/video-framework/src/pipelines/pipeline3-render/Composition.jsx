...
import { shatterWipe } from "../../transitions/shatterWipe/ShatterWipe.jsx";
...
const ASSET_COMPONENTS = {
  ...
  KineticText: lazy(() =>
    import("../../assets/KineticText/KineticText.jsx").then((m) => ({ default: m.KineticText }))
  ),
};
